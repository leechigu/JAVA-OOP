...
public class CalcGUIV1 extends JFrame implements ActionListener {
    ...
    JLabel display = new JLabel(); // �닽�옄 媛� 諛� 寃곌낵 異쒕젰 �솕硫�
    ...
    CalcGUIV1() {
        ...
        clear();
        commandInvoker = new CommandInvoker(calculator,buttons,display);
        commandInvoker.setCommand();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for(int i=0;i<buttons.length;i++) {
        	if(cmdButton==buttons[i])
        		commandInvoker.buttonPushed(i);
        }
    }
